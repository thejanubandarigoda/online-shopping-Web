              ...
              <dl className="mt-2 text-base text-gray-500">
                <div className="mt-3">
                  ...
                  <dd className="flex">
                    ...
                    <span className="ml-3">support@shopease.com</span>
                  </dd>
                </div>
                <div className="mt-3">
                  ...
                  <dd className="flex">
                    ...
                    <span className="ml-3">+1 (888) 123-4567</span>
                  </dd>
                </div>
              </dl>
              <p className="mt-6 text-base text-gray-500">
                Our customer service team is available Monday through Friday, 9am to 5pm ET.
              </p>
            </div>

            <div className="mt-12">
              <h2 className="text-lg font-medium text-gray-900">Headquarters</h2>
              ...
              <p className="mt-4 text-base text-gray-500">
                For business inquiries, please email <a href="mailto:business@shopease.com" className="text-indigo-600 hover:text-indigo-500">business@shopease.com</a>
              </p>
            </div>
